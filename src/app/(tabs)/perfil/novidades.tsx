...
/**
 * Feed completo (conquistas, marcos, o que a comunidade compartilhou) —
 * morava na aba Início antes da Home virar um dashboard (próxima dose,
 * recompra, fidelidade). "Minhas postagens" (perfil/minhas-postagens.tsx)
 * é um recorte menor, só do que o próprio usuário compartilhou — telas
 * diferentes de propósito, mantidas separadas.
 */
